...
<body>
    <div id="sidebar">
        <ul>
            ...
            <li><a class="active" href="contasPagar.html">Contas a pagar</a></li>
    ...
    <div id="content">
        ...
        <table id="customers">
            <tr>
                ...
                <td class="title">Data de vencimento</td>
            </tr>
            <tr>
                <td id="delete"><a href="" id="del-minus">-</a></td>
                <td>Fatura</td>
                <td>Claro</td>
                <td>65,00</td>
                <td>04/01/2022</td>
        ...
        <a href="addConta.php"><div id="adic">+</div></a>
